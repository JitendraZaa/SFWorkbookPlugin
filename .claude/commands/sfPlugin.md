This is Salesforce CLI Custom Plugin Application. $ARGUMENTS

Follow below steps:

1. First think through the problem, read the codebase for relevant files, and write a plan to "Claude/Task/todo_x.md". \_x is incremental file name. If folder "Claude/Task" contains files, then x would be unique incremental from 1, e.g. "todo_1.md", "todo_2.md", etc.
1. Refer Claude_Notes.md to get context of the project and existing codebase.
1. The plan should have a list of todo items that you can check off as you complete them
1. Before you begin working, check in with me and I will verify the plan.
1. Then, begin working on the todo items, marking them as "complete" as you go in file "Claude/Task/todo.md".
...
1. Update README.md to reflect current functionality and usage and any new features added or removed.
